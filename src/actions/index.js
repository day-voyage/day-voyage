...
export function loginUser(username, password, snackbar, signedup) {
    return function(dispatch) {
        ...
        return fetch('https://sleepy-crag-32675.herokuapp.com/v1/access_tokens', {
            method: 'POST',
            // credentials: 'include',
            headers: {
...
export function signUpUser(username, password, email, snackbar) {
  ...
  return function(dispatch) {
    ...
    return fetch('https://sleepy-crag-32675.herokuapp.com/v1/users', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
export function fetchProtectedData(token) {
    ...
    //     return fetch('https://sleepy-crag-32675.herokuapp.com/v1/plans', {
    //             credentials: 'include',
    //             headers: {
...
export function saveActivityToDb(activity, access_token) {
  return dispatch => {
    ...
    return fetch('https://sleepy-crag-32675.herokuapp.com/v1/activities?access_token=' + access_token, {
        method: 'POST',
...
export function deleteActivityFromDb(activityId, cb) {
  return dispatch => {
    ...
    return fetch(`https://sleepy-crag-32675.herokuapp.com/v1/activities/${activityId}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json'
      }
