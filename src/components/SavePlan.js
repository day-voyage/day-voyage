...
export default class SavePlan extends Component {
  ...
  render() {
    ...
    var shareURL = encodeURIComponent(`https://sweatyfigs.api.poly.cloud/?plan=${this.props.plan_id}`);
          ...
          <Tab
            ...
            <div className="container">
              <div className="row">
                ...
                <span style={{color: "#808080"}}><h6>{`https://sweatyfigs.api.poly.cloud/?plan=${this.props.plan_id}`}</h6></span>
